...
class DataProcessor: 
    ...
    def preprocess_data(self,df): 
        try: 
            ...
            cats_cols = self.config["data_processing"]["categorical_columns"]
            nums_cols = self.config["data_processing"]["numerical_columns"] 
            ...
            skewness=df[nums_cols].apply(lambda x:x.skew()) 
    ...
    def select_features(self,df): 
        try:
            ...
            logger.info(f"Featuers selected: {top_10_features}")
    ...
    def save_data(self,df,file_path): 
        try: 
            logger.info("Saving our data in a processed folder")
    ...
    def process(self):
        try: 
            ...
            raise CustomException("Error while preprocessing pipeline data",e)   
