...
class ModelTraining: 
    ...
    def train_lgbm(self,X_train,y_train):  
        try: 
            ...
            logger.info("starting our hyperparameyer tuning")
            
            random_search=RandomizedSearchCV(
                estimator=lgbm_model, 
                param_distributions=self.params_dist, 
                n_iter = self.random_search_params["n_iters"], 
    ...
    def run(self):
        try: 
            with mlflow.start_run():
                ...
                logger.info("Logging the training abd testing dataset to MLFLOW") 
            ...
            logger.error(f"Error in model training pipeline model {e}") 
